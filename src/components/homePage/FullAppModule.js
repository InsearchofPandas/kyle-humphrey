...
const FullAppModule = ({ title, about, id, image_name, link }) => {
  ...
  return (
    ...
    >
      ...
      <Link to={link}>
        ...
        <div
          className="flex w-full justify-center flex-row  items-start "
          ref={ref}
        >
          <img
            className="w-full px-1 "
            src={require(`../../images/code_stills/${image_name}`)}
            alt="menu"
          />
        </div>
      </Link>
