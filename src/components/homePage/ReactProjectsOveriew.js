...
function ReactProjectsOveriew() {
  return (
    <>
      <section
        id="react-projects-overview"
        className="bg-bgColor py-10 pb-16 border-b border-gray-700"
      >
      
        <div className="w-full flex justify-center my-5 ">
          <body className="  flex  flex-wrap justify-center footerColor  pb-6">
          <div className="w-full  flex justify-center  ">
          <Link to="/work/codeing">
            <h3 className="text-2xl md:text-4xl py-10 font-bold border-b border-gray-700">
              React Projects
            </h3>
          </Link>
        </div>
          ...
          {fullApps.map(app => (
            ...
            <div className="w-full  flex justify-center flex-wrap ">
              ...
              * many of these projects are not adaptive or responsive and can only be viewed accurately on a computer browser 
              </p>
            </div>
